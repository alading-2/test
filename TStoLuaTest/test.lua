...
["TStoLuaTest.test1"] = function(...) 
local ____exports = {}
local ____test = require("TStoLuaTest.test")
local add = ____test.add
print(add(1, 2))
return ____exports
 end,
}
return require("TStoLuaTest.test", ...)
